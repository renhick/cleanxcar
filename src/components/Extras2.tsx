    ...
    useEffect(() => {
        const loadServices = async () => {
            try {
                ...
                // Nur die ersten 4 Dienstleistungen anzeigen
            ...
            <div className="w-full p-5 min-h-96 rounded-lg bg-[url('/banner.jpg')] bg-cover bg-center relative">
                ...
                <div className='z-50 relative'>
                    ...
                    <div className='max-w-prose'>
                        <h1 className='text-2xl font-bold text-white break-words mt-2'>
                            Unsere Verfügbaren Extra Dienstleistungen für die Innenraum-Reinigung
                        </h1>
                        <p className='text-white/60'>
                            Verwöhnen Sie Ihr Auto mit zusätzlicher Pflege ganz nach Ihren Wünschen.
                        </p>
                    </div>
